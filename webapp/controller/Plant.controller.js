...
sap.ui.define([
	...
	return BaseController.extend("scsetting.controller.Plant", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("plant").attachPatternMatched(this._onObjectMatched, this);

			this.setModel(oViewModel, "plantView");
		...
		buttonPressed: function() {
			...
			this.getRouter().navTo("plantList", {
					mainContext: sPath
				});
		},
		...
		onShareEmailPress: function() {
			var oViewModel = this.getModel("plantView");
		...
		_onBindingChange: function() {
			...
			var sPath = oElementBinding.getPath(),
				...
				oViewModel = this.getModel("plantView");
