sap.ui.define([
		...
		return BaseObject.extend("scsetting.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias scsetting.model.ListSelector
			 */
			 ...
			 * @return {scsetting.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
