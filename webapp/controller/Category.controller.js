...
sap.ui.define([
	...
	return BaseController.extend("scsetting.controller.Category", {
		...
		onInit: function() {
			...
			this.getRouter().getRoute("category").attachPatternMatched(this._onObjectMatched, this);

			this.setModel(oViewModel, "categoryView");
		...
		onShareEmailPress: function() {
			var oViewModel = this.getModel("categoryView");
		...
		_onBindingChange: function() {
			...
			var sPath = oElementBinding.getPath(),
				...
				oViewModel = this.getModel("categoryView");
