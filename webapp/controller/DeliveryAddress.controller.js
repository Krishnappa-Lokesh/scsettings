...
sap.ui.define([
		...
		return BaseController.extend("scsetting.controller.DeliveryAddress", {
			...
			onInit : function () {
				...
				this.getRouter().getRoute("deliveryAdrs").attachPatternMatched(this._onObjectMatched, this);

				this.setModel(oViewModel, "deliveryAddView");
			...
			buttonPressed: function() {
				...
				this.getRouter().navTo("delvAdrsList", {
						mainContext: sPath
					});
			},

			onShareEmailPress : function () {
				var oViewModel = this.getModel("deliveryAddView");
			...
			_onBindingChange : function () {
				...
				var sPath = oElementBinding.getPath(),
					...
					oViewModel = this.getModel("deliveryAddView");
